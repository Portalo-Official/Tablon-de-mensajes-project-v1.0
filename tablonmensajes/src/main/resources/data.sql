...
-- Usuarios
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(1,'a1b2c3d4e5f6', 'sabrina', 'sabrina@gmail.com', 'pass1234', 'user');
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(2,'b2c3d4e5f6a1', 'angel', 'angel@gmail.com', 'pass1234', 'user');
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(3,'c3d4e5f6a1b2', 'yeray', 'yeray@gmail.com', 'pass1234', 'user');
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(4,'d4e5f6a1b2c3', 'santi', 'santi@gmail.com', 'pass1234', 'user');
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(5,'e5f6a1b2c3d4', 'maria', 'maria@gmail.com', 'pass1234', 'user');
INSERT INTO TB_USUARIOS (id, uuid, username, gmail, password, rol) VALUES(6,'f6a1b2c3d4e5', 'lucas', 'lucas@gmail.com', 'pass1234', 'admin');

-- Categorías
INSERT INTO TB_CATEGORIAS (id, nombre) VALUES (1, 'Doméstico'), (2, 'Jardín'), (3, 'Iluminación'), (4, 'Finanzas');

-- Posts
INSERT INTO TB_POSTS (id, uuid, titulo, contenido, fecha_publicacion, usuario_id) VALUES(1,'1a2b3c4d5e6f', 'Cómo mantener tu hogar limpio', '1. Limpia diariamente las superficies principales, como mesas y encimeras, para evitar acumulaciones. 2. Dedica 15 minutos diarios a recoger los objetos fuera de lugar. 3. Usa productos de limpieza ecológicos para proteger tu hogar y el medio ambiente. 4. Implementa un sistema de organización: etiquetas y contenedores pueden ser muy útiles. 5. Lava los trapos y utensilios de limpieza con frecuencia para evitar malos olores y bacterias.', TIMESTAMP '2024-12-23 10:00:00', 1);
INSERT INTO TB_POSTS (id, uuid, titulo, contenido, fecha_publicacion, usuario_id) VALUES(2,'2b3c4d5e6f1a', 'Mejorando tu jardín', 'Riega tus plantas temprano en la mañana, usa compost natural y crea espacios con plantas de bajo mantenimiento para un jardín espectacular.', TIMESTAMP '2024-12-22 09:30:00', 2);
